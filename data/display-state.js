...
export const DISPLAY_STATE = {
  ...
  banks: [
    {
      ...
      branch:    '076',
      location:  'תל אביב',
      logo:      'assets/logos/discount_bank_logo.jpg',
      isPrimary: true,
    },
    {
      id:        'mizrahi',
      ...
      branch:    '418',
      location:  'הרצליה',
      logo:      'assets/logos/mizrahi_tefahot_logo.png',
      isPrimary: false,
    },
  ],
  ...
  providers: [
    ...
    },
    {
      ...
      name:   'הפניקס',
      nameEn: 'The Phoenix',
      logo:   'assets/logos/fnx_logo.png',
    },
    {
      id:     'yelin',
      name:   'ילין לפידות',
      nameEn: 'Yelin Lapidot',
      logo:   'assets/logos/yl_lapidot_logo.png',
    },
    {
      id:     'meitav',
      name:   'מיטב',
      nameEn: 'Meitav',
      logo:   'assets/logos/meitav_logo.jpeg',
    },
    {
      id:     'idf',
      name:   'צה״ל',
  ...
  // ── Vouchers & gift cards (demo) ─────────────────────────────
  // Hand-written placeholders. Bilingual store aliases so the
  // page's search works in both languages. Attachments use tiny
  // inline data URIs — never real files — so the public demo
  // touches zero Supabase Storage state. Status is derived at
  // render time from expirationDate + remainingAmount, not stored.
  giftCards: [
    {
      id:              'voucher-demo-shufersal',
      title:           'שובר שופרסל',
      titleEn:         'Shufersal voucher',
      originalAmount:  200,
      remainingAmount: 100,
      currency:        'ILS',
      stores: [
        { he: 'שופרסל',       en: 'Shufersal' },
        { he: 'שופרסל אקספרס', en: 'Shufersal Express' },
      ],
      isSingleStore:   false,
      expirationDate:  '2026-09-30',
      issueDate:       '2026-02-14',
      code:            '4901-7732-8841-2204',
      notes:           'שווה לבדוק אם זה תקף גם ב-Online.',
      attachment: {
        ref:       'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=',
        mime:      'image/png',
        sizeBytes: 70,
        name:      'shufersal-receipt.png',
        addedAt:   '2026-02-14',
      },
    ...
    },
    {
      id:              'voucher-demo-fox',
      title:           'תו פוקס',
      titleEn:         'Fox gift card',
      originalAmount:  150,
      remainingAmount: 150,
      currency:        'ILS',
      stores: [
        { he: 'פוקס',      en: 'Fox' },
        { he: 'פוקס הום',  en: 'Fox Home' },
        { he: 'פוקס בייבי', en: 'Fox Baby' },
      ],
      isSingleStore:   false,
    ...
    {
      id:              'voucher-demo-superpharm',
      title:           'זיכוי סופר-פארם',
      titleEn:         'Super-Pharm credit',
      originalAmount:  80,
      remainingAmount: 80,
      currency:        'ILS',
      stores: [
        { he: 'סופר-פארם', en: 'Super-Pharm' },
      ],
      isSingleStore:   true,
      expirationDate:  null,
      issueDate:       '2026-05-02',
      code:            null,
      notes:           'זיכוי על החזרה. אין תאריך תפוגה מודפס.',
      attachment:      null,
      createdAt:       '2026-05-02',
      updatedAt:       '2026-05-02',
    },
    {
      id:              'voucher-demo-mall',
      title:           'תו רב-תכליתי - דיזנגוף סנטר',
      titleEn:         'Dizengoff Center multi-store voucher',
      originalAmount:  500,
      remainingAmount: 500,
      currency:        'ILS',
      stores: [
        { he: 'קסטרו',     en: 'Castro' },
        { he: 'גולף',      en: 'Golf' },
        { he: 'אמריקן איגל', en: 'American Eagle' },
        { he: 'זארה',      en: 'Zara' },
      ],
      isSingleStore:   false,
      expirationDate:  '2027-12-31',
      issueDate:       '2025-12-25',
      code:            'DZ-MALL-58821903',
    ...
    {
      id:              'voucher-demo-toysrus',
      title:           'תו טויס-אר-אס (פג)',
      titleEn:         'ToysRUs gift card (expired)',
      originalAmount:  100,
      remainingAmount: 40,
      currency:        'ILS',
      stores: [
        { he: 'טויס אר אס', en: 'ToysRUs' },
      ],
      isSingleStore:   true,
      expirationDate:  '2025-12-31',
      issueDate:       '2024-09-10',
      code:            'TRU-12-345-678',
      notes:           'נשכח במגירה — פג לפני חצי שנה.',
      attachment:      null,

...
export const LOGO_LIBRARY = [
  ...
  { path: 'assets/logos/mercantile_logo.png',      en: 'Mercantile Discount', he: 'מרכנתיל דיסקונט' },
  { path: 'assets/logos/jerusalem_logo.png',       en: 'Bank of Jerusalem', he: 'בנק ירושלים' },
  { path: 'assets/logos/massad_logo.png',          en: 'Bank Massad',     he: 'בנק מסד' },
  { path: 'assets/logos/pagi_logo.png',            en: 'PAGI',            he: 'בנק פאגי' },
